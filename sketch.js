...
function setup() {
  ...
  box9 = new Box(700, 250, 70, 70);
  box10 = new Box(700, 300, 70, 70);
  box11 = new Box(790, 50, 70, 70);
  box12 = new Box(790,100,70,70);
  box13 = new Box(790,150,70,70);
  box14 = new Box(790, 200, 70, 70);
  box15 = new Box(790, 250, 70, 70);
  box16 = new Box(790, 300, 70, 70);
